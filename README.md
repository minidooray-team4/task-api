...
# DTO
| Domain  | Request DTO            | Fields                               |
| ------- | ---------------------- | ------------------------------------ |
| Project | `CreateProjectRequest` | `name`                               |
| Project | `UpdateProjectRequest` | `name(nullable)`, `status(nullable)` |

| Domain  | Response DTO             | Fields                                  |
| ------- | ------------------------ | --------------------------------------- |
| Project | `ProjectResponse`        | `id`, `name`, `status`, `adminMemberId` |
| Project | `ProjectSummaryResponse` | `id`, `name`, `status`, `adminMemberId` |
| Project | `ProjectDetailResponse`  | `id`, `name`, `status`, `adminMemberId` |
| Project | `ProjectMemberResponse`  | `id`, `projectId`, `memberId`           |
...
| Domain | Request DTO         | Fields                                                |
| ------ | ------------------- | ----------------------------------------------------- |
| Task   | `CreateTaskRequest` | `title`, `content(nullable)`, `milestoneId(nullable)` |
| Task   | `UpdateTaskRequest` | `title(nullable)`, `content(nullable)`                |

| Domain | Response DTO          | Fields                                                                                               |
| ------ | --------------------- | ---------------------------------------------------------------------------------------------------- |
| Task   | `TaskResponse`        | `id`, `projectId`, `title`, `content`, `writerMemberId`, `milestoneId(nullable)`                     |
| Task   | `TaskSummaryResponse` | `id`, `projectId`, `title`, `writerMemberId`, `milestoneId(nullable)`                                |
| Task   | `TaskDetailResponse`  | `id`, `projectId`, `title`, `content`, `writerMemberId`, `milestoneId(nullable)`, `tags`, `comments` |
...
| Domain  | Request DTO            | Fields    |
| ------- | ---------------------- | --------- |
| Comment | `CreateCommentRequest` | `content` |
| Comment | `UpdateCommentRequest` | `content` |

| Domain  | Response DTO      | Fields                                      |
| ------- | ----------------- | ------------------------------------------- |
| Comment | `CommentResponse` | `id`, `taskId`, `writerMemberId`, `content` |
...
| Domain | Request DTO        | Fields |
| ------ | ------------------ | ------ |
| Tag    | `CreateTagRequest` | `name` |
| Tag    | `UpdateTagRequest` | `name` |

| Domain | Response DTO  | Fields                    |
| ------ | ------------- | ------------------------- |
| Tag    | `TagResponse` | `id`, `projectId`, `name` |
...
| Domain    | Request DTO              | Fields |
| --------- | ------------------------ | ------ |
| Milestone | `CreateMilestoneRequest` | `name` |
| Milestone | `UpdateMilestoneRequest` | `name` |

| Domain    | Response DTO        | Fields                    |
| --------- | ------------------- | ------------------------- |
| Milestone | `MilestoneResponse` | `id`, `projectId`, `name` |
